      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-800 rounded-2xl shadow-2xl overflow-hidden border border-slate-700 w-full h-auto">
          ...
          <form className="w-full flex flex-col gap-4 px-6 pb-6 pt-3"   onSubmit={handleSubmit}>
            ...
            <div>
             < span className="text-white text-[14px] font-semibold">doesn't Signed yet ?</span> <Link to="/signup" className="text-teal-500 text-[14px] font-semibold ml-1">Sign Up</Link>
            </div>
            <div>
              <button
                type="submit"
